package com.example.android.WIRADHIKADWIPUTRA_1202151228_MODUL2;
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            ...
            photoItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(itemView.getContext(), com.example.android.WIRADHIKADWIPUTRA_1202151228_MODUL2.DetailMenu.class);
